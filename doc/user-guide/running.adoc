...
_inspector_ output may be optionally pseudo-anonymised. This means that
all client IP addresses in PCAP output are pseudo-anonymised, as are
all IP addresses in counts of events recorded.
...
Without knowledge of the key used in this process it is not possible to
