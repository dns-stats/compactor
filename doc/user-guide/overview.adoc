...
https://tools.ietf.org/html/draft-ietf-dnsop-dns-capture-format-10[version
10].
====
...
https://tools.ietf.org/html/draft-ietf-dnsop-dns-capture-format-10[version
10] of the draft,  with the following changes:

* A private version ID of 1 is present.

_inspector_ reads C-DNS as described in version 10 of
the draft, and is intended to remain backwards compatible in any
